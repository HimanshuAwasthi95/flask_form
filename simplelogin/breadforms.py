...
class loginform(Form):
    ...
    email    = StringField('Email',[validators.DataRequired(),validators.Email()], default="example@username.com")
...
class registerform(Form):
    ...
    state = SelectField('State',choices=[('Utter Pradesh','UP'),('New Delhi','ND')])
